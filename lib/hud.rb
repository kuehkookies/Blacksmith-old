class HUD < Chingu::BasicGameObject
	...
	def initialize(options={})
		...
		@sub = Image["misc/hud_#{$window.subweapon}.png"] unless $window.subweapon == :none
	...
	def update
		...
		@sub = Image["misc/hud_#{$window.subweapon}.png"] unless $window.subweapon == @sub or $window.subweapon == :none
